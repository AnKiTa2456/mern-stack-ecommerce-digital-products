...
<footer className="footer p-10 bg-base-200 text-base-content">
  <aside>
    <h2 className='text-3xl'>BuyBolt</h2>
    <p>Providing reliable tech since 2024</p>
  </aside> 
  <nav>
    <h6 className="footer-title">Social</h6> 
    <div className="grid grid-flow-col gap-4">
      <a href='https://www.linkedin.com/in/ankita-patel-859508220/'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
  ...
  <nav>
    ...
    <a className="link link-hover">p.ankita10101@gmail.com</a>
    <a className="link link-hover">+91-9569378421</a>
  </nav> 
